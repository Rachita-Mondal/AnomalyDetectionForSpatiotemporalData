...
parser.add_argument('--path_options', type=json.loads, default={'outvalue':'results_dur_15'},help="optimize options")
parser.add_argument('--iter_options', type=json.loads, default={'rep':0}, help="iter options")
args = parser.parse_args()

if __name__ == '__main__':
    path = '/mnt/home/mondalra/Anomaly_Detection/LRSSS/Varying_Duration/'
    ...
    for m, model in enumerate(models):
        ...
        df = pd.DataFrame(res)
        filename = path_out+'LRSSS_dur_'+str(duration)+'_rep'+str(rep)+'.csv'
