...
def horpca_objective(trial):
    ...
    likelihood_scores, likelihood_detection = likelihood_scoring(horpca, G, sig=0.999)
...
study.optimize(horpca_objective, n_trials=500, show_progress_bar=True)
...
filename = path_out+'HORPCA_m'+str(machine_id)+'_c'+str(channel_id)+'.csv'
