...
if __name__ == '__main__':
    path = '/mnt/home/mondalra/Anomaly_Detection/LRSTS/Varying_Amplitude/'
    path_out = path+args.path_options['outvalue']+'/'
    rep = args.iter_options['rep']
    models = ['lr_sts'] #['lr_stss', 'lr_sts', 'lr_sss', 'horpca']
    duration = 10
    n_trials = 500
    n_iteration = 1
    radius = 2
    ...
    for m, model in enumerate(models):
        ...
        df = pd.DataFrame(res)
        filename = path_out+'LRSTS_amp_'+str(amplitude)+'_rep'+str(rep)+'.csv'
